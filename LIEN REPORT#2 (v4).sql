...
SET @CreditOffice = 9846										--Should be parameter in final report
...
and DATEDIFF (d, ate.shipDate, getdate()) > 30					--Should be parameter in final report
